      ...
      >
          ...
          <div class="table p-abs">
            ...
            <div class="table-content">
              <div class="tr flex flex-between">
                ...
                <div
                  class="td"
                  v-text="$t('currencyType')"
                ></div>
                <div
                  class="td"
                  v-text="$t('latestPrice')"
                ></div>
                <div
                  class="td"
                  v-text="$t('high')"
              ...
              >
                ...
                >
                  <div
                    @click="addMylist(item,index)"
                    class="td"
                  >
                    <i
                      :class="item.isMyLike?'el-icon-star-on':'el-icon-star-off'"
                      class="font-16"
                    ></i>
                  </div>
        ...
        <div class="price flex fl">
          <div class="item h-full">
            <em class="font-16 color-success font-bold">{{(latestData.prise||0)*1}}</em>&nbsp;
            <em class="price-1 font-12">≈&nbsp;￥{{(latestData.cny||0)*1}}</em>
          </div>
          <i class="tag">|</i>
          ...
          <div class="item h-full fl">
            <em
              ...
              v-text="$t('high')"
            ></em>
            <em class="price-1 font-14">{{(latestData.height||0)*1}}</em>
          </div>
          <i class="tag">|</i>
          <div class="item h-full fl">
            <em
              ...
              v-text="$t('low')"
            ></em>
            <em class="price-1 font-14">{{(latestData.low||0)*1}}</em>
          </div>
          <i class="tag">|</i>
          <div class="item h-full fl">
            <em
              ...
              v-text="$t('dayVol')"
            ></em>
            <em class="price-1 font-14">{{(latestData.number||0)*1}}</em>
          </div>
        </div>
      </div>
    </my-header>
      ...
      <div class="k-map">
        ...
        <div class="trade-panel flex flex-between">
          <div class="trade-table">
            ...
            <!-- 买入五档图 -->
            <ul
              v-if="latestSoldData.length>0"
              class="tb-left trade-body"
            >
              <li
              ...
              >
                ...
                <div
                  ...
                  class="p-abs progress"
                ></div>
              </li>
            </ul>
            <div
              v-else
              class="table-no-data txt-center"
              v-text="$t('label108')"
            ></div>
            <!-- 最新价 -->
            <div
              v-show="latestData.prise*1"
              class="newprice txt-center color-danger"
            >
              <span class="font-16">
                {{latestData.prise*1}}
              </span>
          ...
          <div class="trade-table">
            ...
            <ul
              v-if="historicalBuyData.length>0"
              class="tb-right trade-body"
            >
              <li
              ...
              >
                <span
                  class="color-666 tr-mPrice"
                  v-text="item.writedate"
                ></span>
                <span
                  class="tr-name color-danger"
                  v-text="item.price*1"
                ></span>
                <span
                  class="tr-vol"
        ...
        <div class="record">
          <div class="entrust_btn">
            <div
              class="btn"
              @click="changeTable(0)"
              :class="contentId==0?'click':''"
            >{{$t('currEnstrument')}}</div>
            <div
              class="btn"
              @click="changeTable(1)"
              :class="contentId==1?'click':''"
            >{{$t('oldEnstrument')}}</div>
          </div>
            ...
            >
              ...
              <div class="entr-body">
                ...
                >
                  ...
                  <div
                    style="flex:1.5;"
                    v-text="item.dealnumber*item.price"
                  ></div>
                  <div
                    style="flex:1.5;"
                    v-text="item.tradgas"
          ...
          <div class="transaction-content">
            ...
            <div class="form transaction-sell">
              ...
              <p class="transaction-input flex flex-between">
                <span
                  @click="changeNum(0.25,1)"
                  class="percentage"
                >25%</span>
                <span
                  @click="changeNum(0.5,1)"
                  class="percentage"
                >50%</span>
                <span
                  @click="changeNum(0.75,1)"
                  class="percentage"
                >75%</span>
                <span
                  @click="changeNum(1,1)"
            ...
            <div class="form transaction-buy">
              ...
              <p class="transaction-input flex flex-between">
                <span
                  @click="changeNum(0.25,2)"
                  class="percentage"
                >25%</span>
                <span
                  @click="changeNum(0.5,2)"
                  class="percentage"
                >50%</span>
                <span
                  @click="changeNum(0.75,2)"
                  class="percentage"
                >75%</span>
                <span
                  @click="changeNum(1,2)"
