        ...
        <div class="panel-container flex flex-between">
          <div class="content-lf">
            <div class="market-trend">
              <div class="panel-title flex flex-v-center flex-between">
                <div class="flex flex-v-center">
                  <img
                    v-if="currentCoinInfo.logo"
            ...
            <div class="form">
              <div class="panel-title font-18">限价交易</div>
              <!-- 买入 -->
              <div class="form-content flex flex-between">
                <div class="form-wrap">
                  <div
            ...
            <div class="entrust">
              <div class="panel-title font-18 font-bit-bold">
                <span
                  @click="onEntrustTabChange(0)"
                  class="tab-item"
                  :class="entrustTabIndex==0?'active':''"
                  v-text="$t('currEnstrument')||'当前委托'"
                ></span>
                <span
                  @click="onEntrustTabChange(1)"
                  class="tab-item"
                  :class="entrustTabIndex==1?'active':''"
                  v-text="$t('oldEnstrument')||'历史委托'"
                ></span>
              </div>
              <template v-if="userData.isLogin">
                <el-table
                  v-show="entrustTabIndex==0"
                  stripe
                  max-height='300'
          ...
          <div class="content-rt">
            ...
            <div class="trade-market">
              <div class="panel-title flex flex-between flex-v-center">
                <span class='font-18'>
                  <i v-text="$t('latestPrice')"></i>
                  <em class="color-danger">{{currentCoinInfo.prise*1}}</em>
                </span>
              </div>
              <div class="table">
...
export default {
  ...
  methods: {
    ...
    // 切换委托记录
    onEntrustTabChange(index) {
      this.entrustTabIndex = index;
    },
    //页面请求
