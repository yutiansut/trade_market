    ...
    >
      ...
      >
        <template slot-scope="scope">
          <div class="operate">
            <img
              v-if='scope.row.icon||scope.row.logo'
              class="thumb-20 m-right-10"
              :src="scope.row.icon||scope.row.logo"
              alt=""
            >
      ...
      >
        <template slot-scope="scope">
          <span
            :class="scope.row.rise*1>0?'color-danger':'color-success'"
      ...
      >
        <template slot-scope="scope">
          ...
          >
            <i
              class="font-18 flex-center color-danger"
