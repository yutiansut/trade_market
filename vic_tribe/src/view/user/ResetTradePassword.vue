<template>
  <div class="app-main wh-full">
    ...
    <div class="app-body h-full">
      <div class="tips font-12 color-666">*&nbsp;新用户默认支付密码为：123456</div>
      <van-cell-group>
        <van-field
          v-model="phone"
...
import { modifyPayPass, getSmsCode } from "@/vuexStore/commonController.js";
export default {
  mixins: [verCodeMixin],
  data() {
    return {
  ...
  methods: {
    ...
    getCode() {
      ...
      getSmsCode(this.phone, 4).then(res => {
        this.timeCountDown();
      });
    },
    saveChange() {
